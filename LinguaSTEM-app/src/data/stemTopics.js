export const STEM_TOPICS = [
  ...
  {
    "cat": "Marketing",
    "tags": ["business", "marketing", "clep", "ap"],
    "title": "Principles of Marketing — 4 Ps, STP & Consumer Behavior",
    "theory": "",
    "reality": "Every product you've ever bought went through a marketing decision: who is the target, what's the message, where to sell it, what to charge. The CLEP Principles of Marketing exam tests three big frameworks — STP (segment-target-position), the 4 Ps (the marketing mix), and the 5-stage consumer buying process.",
    "formula": "STP framework:\n  Segmentation → Targeting → Positioning\n\nThe 4 Ps (marketing mix):\n  • PRODUCT    – features, branding, life cycle\n  • PRICE      – skimming, penetration, value-based\n  • PLACE      – distribution channels & intensity\n  • PROMOTION  – advertising, PR, sales promo, personal selling, direct\n\nConsumer buying process:\n  Need → Search → Evaluate → Purchase → Post-purchase\n\nProduct life cycle:\n  Introduction → Growth → Maturity → Decline",
    "method": "When solving a marketing-mix question, name which of the 4 Ps it touches first — most CLEP questions are 4 Ps in disguise. For consumer-behavior questions, locate the stage in the 5-step buying process. For market-strategy questions, ask: are we segmenting, targeting, or positioning?",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">The 4 Ps — Marketing Mix</text>\n  <rect x=\"14\" y=\"22\" width=\"52\" height=\"38\" rx=\"6\" fill=\"rgba(122,171,207,.15)\" stroke=\"#7aabcf\" stroke-width=\"0.8\"/>\n  <text x=\"40\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7aabcf\" font-weight=\"700\">PRODUCT</text>\n  <text x=\"40\" y=\"49\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">features</text>\n  <text x=\"40\" y=\"57\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">brand · PLC</text>\n  <rect x=\"70\" y=\"22\" width=\"52\" height=\"38\" rx=\"6\" fill=\"rgba(201,160,96,.15)\" stroke=\"#c9a060\" stroke-width=\"0.8\"/>\n  <text x=\"96\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c9a060\" font-weight=\"700\">PRICE</text>\n  <text x=\"96\" y=\"49\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">skim/penetrate</text>\n  <text x=\"96\" y=\"57\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">value-based</text>\n  <rect x=\"126\" y=\"22\" width=\"52\" height=\"38\" rx=\"6\" fill=\"rgba(122,176,96,.15)\" stroke=\"#7ab060\" stroke-width=\"0.8\"/>\n  <text x=\"152\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7ab060\" font-weight=\"700\">PLACE</text>\n  <text x=\"152\" y=\"49\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">channels</text>\n  <text x=\"152\" y=\"57\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">intensity</text>\n  <rect x=\"182\" y=\"22\" width=\"64\" height=\"38\" rx=\"6\" fill=\"rgba(192,112,112,.15)\" stroke=\"#c07070\" stroke-width=\"0.8\"/>\n  <text x=\"214\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c07070\" font-weight=\"700\">PROMOTION</text>\n  <text x=\"214\" y=\"49\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">ads · PR · sales</text>\n  <text x=\"214\" y=\"57\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">push vs pull</text>\n  <line x1=\"14\" y1=\"68\" x2=\"246\" y2=\"68\" stroke=\"#5e5e5e\" stroke-width=\"0.4\"/>\n  <text x=\"14\" y=\"82\" font-size=\"8\" fill=\"#9ecef0\" font-weight=\"700\">Buyer journey:</text>\n  <text x=\"14\" y=\"96\" font-size=\"8\" fill=\"#a0c888\">Need → Search → Evaluate → Buy → Post-purchase</text>\n  <text x=\"14\" y=\"107\" font-size=\"7\" fill=\"#888\">Marketers design touchpoints at every stage</text>\n </svg>",
    "caption": "Marketing mix = 4 Ps. Each P has its own playbook. Buyer journey runs in parallel.",
    "steps": [
      "Identify the marketing problem: is it about the product, the price, the channel, or the message? That tells you which P.",
      "For segmentation questions, name the base: demographic, geographic, psychographic, or behavioral.",
      "For pricing questions, distinguish penetration (low to grab share) from skimming (high to harvest early adopters).",
      "For distribution questions, ask: intensive (everywhere), selective (some), or exclusive (one per area)?",
      "For promotion questions, separate push (firm → channel) from pull (firm → consumer → channel) strategies."
    ],
    "example": "A new energy drink launches at a low introductory price (penetration), is sold in every gas station (intensive), uses TikTok ads aimed at 18–24-year-olds (psychographic + demographic targeting), and runs a buy-one-get-one promo (sales promotion). Each decision touches a different P."
  },
  {
    "cat": "Management",
    "tags": ["business", "management", "clep"],
    "title": "Principles of Management — POLC, Span of Control & Motivation",
    "theory": "",
    "reality": "Whether running a Subway store or a Fortune 500, management decisions follow the same four functions: planning, organizing, leading, controlling. CLEP Principles of Management tests POLC, classical motivation theories (Maslow, Herzberg, McGregor), and structural concepts like span of control and chain of command.",
    "formula": "POLC functions of management:\n  • PLANNING     – set goals & strategies\n  • ORGANIZING   – design structure, allocate resources\n  • LEADING      – motivate & direct people\n  • CONTROLLING  – measure results, adjust\n\nMotivation theories:\n  Maslow      – Physiological → Safety → Social → Esteem → Self-actualization\n  Herzberg    – Hygiene factors prevent dissatisfaction; motivators drive satisfaction\n  McGregor    – Theory X (workers dislike work) vs Theory Y (workers seek challenge)\n\nStructure:\n  Span of control = number of direct reports\n  Wide span → flat hierarchy; narrow span → tall hierarchy",
    "method": "Name the management function (POLC) before answering — most CLEP questions map directly to one. For motivation questions, recall: Maslow stacks, Herzberg splits hygiene from motivators, McGregor contrasts assumption sets. For structure questions, draw the org chart.",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">POLC — Four Functions of Management</text>\n  <defs><marker id=\"polc\" markerWidth=\"6\" markerHeight=\"6\" refX=\"5\" refY=\"3\" orient=\"auto\"><path d=\"M0,0 L6,3 L0,6 Z\" fill=\"#7aabcf\"/></marker></defs>\n  <rect x=\"10\" y=\"22\" width=\"52\" height=\"32\" rx=\"6\" fill=\"rgba(122,171,207,.15)\" stroke=\"#7aabcf\" stroke-width=\"0.8\"/>\n  <text x=\"36\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7aabcf\" font-weight=\"700\">PLAN</text>\n  <text x=\"36\" y=\"48\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">set goals</text>\n  <line x1=\"63\" y1=\"38\" x2=\"73\" y2=\"38\" stroke=\"#7aabcf\" stroke-width=\"1.2\" marker-end=\"url(#polc)\"/>\n  <rect x=\"74\" y=\"22\" width=\"52\" height=\"32\" rx=\"6\" fill=\"rgba(201,160,96,.15)\" stroke=\"#c9a060\" stroke-width=\"0.8\"/>\n  <text x=\"100\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c9a060\" font-weight=\"700\">ORGANIZE</text>\n  <text x=\"100\" y=\"48\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">structure</text>\n  <line x1=\"127\" y1=\"38\" x2=\"137\" y2=\"38\" stroke=\"#7aabcf\" stroke-width=\"1.2\" marker-end=\"url(#polc)\"/>\n  <rect x=\"138\" y=\"22\" width=\"52\" height=\"32\" rx=\"6\" fill=\"rgba(122,176,96,.15)\" stroke=\"#7ab060\" stroke-width=\"0.8\"/>\n  <text x=\"164\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7ab060\" font-weight=\"700\">LEAD</text>\n  <text x=\"164\" y=\"48\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">motivate</text>\n  <line x1=\"191\" y1=\"38\" x2=\"201\" y2=\"38\" stroke=\"#7aabcf\" stroke-width=\"1.2\" marker-end=\"url(#polc)\"/>\n  <rect x=\"202\" y=\"22\" width=\"52\" height=\"32\" rx=\"6\" fill=\"rgba(192,112,112,.15)\" stroke=\"#c07070\" stroke-width=\"0.8\"/>\n  <text x=\"228\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c07070\" font-weight=\"700\">CONTROL</text>\n  <text x=\"228\" y=\"48\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">measure</text>\n  <line x1=\"228\" y1=\"56\" x2=\"228\" y2=\"66\" stroke=\"#888\" stroke-width=\"0.6\" stroke-dasharray=\"2,2\"/>\n  <line x1=\"228\" y1=\"66\" x2=\"36\" y2=\"66\" stroke=\"#888\" stroke-width=\"0.6\" stroke-dasharray=\"2,2\"/>\n  <line x1=\"36\" y1=\"66\" x2=\"36\" y2=\"56\" stroke=\"#888\" stroke-width=\"0.6\" stroke-dasharray=\"2,2\" marker-end=\"url(#polc)\"/>\n  <text x=\"130\" y=\"77\" text-anchor=\"middle\" font-size=\"7\" fill=\"#888\">feedback loop — control informs next planning cycle</text>\n  <rect x=\"10\" y=\"82\" width=\"244\" height=\"24\" rx=\"6\" fill=\"rgba(40,50,70,.30)\" stroke=\"#5e5e5e\" stroke-width=\"0.6\"/>\n  <text x=\"130\" y=\"94\" text-anchor=\"middle\" font-size=\"7.5\" fill=\"#9ecef0\" font-weight=\"700\">MASLOW: physiological → safety → social → esteem → self-act.</text>\n  <text x=\"130\" y=\"103\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">HERZBERG: hygiene (prevent ↓) vs motivators (drive ↑)</text>\n </svg>",
    "caption": "POLC is a cycle: control feeds back into planning. Motivation theories layer on top.",
    "steps": [
      "Map every management question to one of POLC: planning, organizing, leading, or controlling.",
      "For motivation: Maslow stacks needs vertically; Herzberg splits hygiene (pay, conditions) from motivators (achievement, recognition).",
      "Wide span of control = flat structure (fewer layers); narrow span = tall structure (more layers, more control).",
      "Distinguish line authority (direct command) from staff authority (advisory).",
      "For decisions: programmed (routine, rules-based) vs nonprogrammed (novel, judgment-based)."
    ],
    "example": "A manager sets quarterly sales goals (Plan), assigns regions to reps (Organize), runs a recognition program for top performers (Lead — Herzberg motivator), and reviews weekly dashboards (Control). Same POLC cycle whether the team is 5 or 5,000."
  },
  {
    "cat": "Business Law",
    "tags": ["business", "law", "clep"],
    "title": "Introductory Business Law — Contracts: The 4 Essentials",
    "theory": "",
    "reality": "Every business deal — buying a car, signing a lease, accepting a job offer — is a contract. CLEP Business Law leans heavily on contracts (30–40% of the exam). Get the four formation elements down cold and you can answer most contract questions, including offer-and-acceptance puzzles, capacity issues, and Statute of Frauds traps.",
    "formula": "Four essentials of a valid contract:\n  1. OFFER          – definite, communicated to offeree\n  2. ACCEPTANCE     – mirror image, communicated back\n  3. CONSIDERATION  – something of value exchanged on both sides\n  4. CAPACITY + LEGALITY – parties competent; subject matter legal\n\nStatute of Frauds — these MUST be in writing:\n  • Sale of land\n  • Contracts > 1 year to perform\n  • Sale of goods ≥ $500 (UCC)\n  • Promise to pay another's debt\n  • Marriage-related promises\n\nRemedies for breach:\n  • Compensatory damages   – cover loss\n  • Consequential damages  – foreseeable indirect loss\n  • Specific performance   – when item is unique (real estate)\n  • Rescission             – cancel & restore\n\nDefenses (bars to enforcement):\n  Mistake · Misrepresentation · Duress · Undue influence · Unconscionability · Illegality",
    "method": "For any contract question, run the 4-element checklist: offer? acceptance? consideration? capacity & legality? If any fails, no contract. If contract exists, ask whether Statute of Frauds requires a writing — if yes and there's no writing, unenforceable.",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">Four Essentials of a Valid Contract</text>\n  <rect x=\"10\" y=\"20\" width=\"58\" height=\"42\" rx=\"6\" fill=\"rgba(122,171,207,.15)\" stroke=\"#7aabcf\" stroke-width=\"0.8\"/>\n  <text x=\"39\" y=\"34\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7aabcf\" font-weight=\"700\">1. OFFER</text>\n  <text x=\"39\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">definite</text>\n  <text x=\"39\" y=\"56\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">communicated</text>\n  <rect x=\"72\" y=\"20\" width=\"58\" height=\"42\" rx=\"6\" fill=\"rgba(201,160,96,.15)\" stroke=\"#c9a060\" stroke-width=\"0.8\"/>\n  <text x=\"101\" y=\"34\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c9a060\" font-weight=\"700\">2. ACCEPT</text>\n  <text x=\"101\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">mirror image</text>\n  <text x=\"101\" y=\"56\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">unconditional</text>\n  <rect x=\"134\" y=\"20\" width=\"58\" height=\"42\" rx=\"6\" fill=\"rgba(122,176,96,.15)\" stroke=\"#7ab060\" stroke-width=\"0.8\"/>\n  <text x=\"163\" y=\"34\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7ab060\" font-weight=\"700\">3. CONSID.</text>\n  <text x=\"163\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">value both</text>\n  <text x=\"163\" y=\"56\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">sides</text>\n  <rect x=\"196\" y=\"20\" width=\"58\" height=\"42\" rx=\"6\" fill=\"rgba(192,112,112,.15)\" stroke=\"#c07070\" stroke-width=\"0.8\"/>\n  <text x=\"225\" y=\"34\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c07070\" font-weight=\"700\">4. CAPACITY</text>\n  <text x=\"225\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">competent</text>\n  <text x=\"225\" y=\"56\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">+ legal</text>\n  <line x1=\"10\" y1=\"68\" x2=\"254\" y2=\"68\" stroke=\"#5e5e5e\" stroke-width=\"0.4\"/>\n  <text x=\"14\" y=\"80\" font-size=\"8\" fill=\"#9ecef0\" font-weight=\"700\">Statute of Frauds — must be WRITTEN:</text>\n  <text x=\"14\" y=\"91\" font-size=\"7.5\" fill=\"#a0c888\">land · &gt;1 year · goods ≥ $500 · suretyship · marriage</text>\n  <text x=\"14\" y=\"103\" font-size=\"7\" fill=\"#888\">If any element fails → no enforceable contract</text>\n </svg>",
    "caption": "All four elements required. Statute of Frauds adds a writing requirement for high-stakes contracts.",
    "steps": [
      "Test for OFFER: was it definite, with clear terms, communicated to a specific offeree? An ad is usually an invitation to treat, not an offer.",
      "Test for ACCEPTANCE: mirror image rule — any change creates a counter-offer, killing the original.",
      "Test for CONSIDERATION: each side must give up something. Past consideration and pre-existing duty don't count.",
      "Test for CAPACITY/LEGALITY: minors and the mentally incapacitated can void; illegal subject matter voids the contract entirely.",
      "If contract exists, check Statute of Frauds: land, > 1 year, goods ≥ $500, suretyship, marriage = needs writing."
    ],
    "example": "A buys B's car for $5,000 — verbal deal. Goods ≥ $500 → Statute of Frauds requires a writing. Without one, the contract exists but is unenforceable in court. Adding a signed bill of sale fixes it."
  },
  {
    "cat": "Information Systems",
    "tags": ["business", "tech", "clep", "is"],
    "title": "Information Systems — Hardware, Networks & Security",
    "theory": "",
    "reality": "Every modern business runs on information systems: PCs, servers, networks, databases, and the security layers protecting them. CLEP Information Systems tests the core stack — hardware classes, network types (LAN/WAN/VPN), software development methods, and security threats.",
    "formula": "Computer hierarchy (small → large):\n  Embedded → PC → Workstation → Server → Mainframe → Supercomputer\n\nNetwork scopes:\n  • PAN  – personal area (Bluetooth, ~10 m)\n  • LAN  – local (one building)\n  • WAN  – wide area (cities, internet)\n  • VPN  – virtual private network over public infrastructure\n\nSDLC phases:\n  Plan → Analyze → Design → Implement → Test → Deploy → Maintain\n\nThreat taxonomy:\n  Virus · Worm · Trojan · Ransomware · Spyware · Phishing · DoS\n\nCIA security triad:\n  Confidentiality · Integrity · Availability",
    "method": "Match the right tool to the right scope. Wireless mouse → PAN. Office wifi → LAN. Cloud storage from home → WAN/Internet. Locking down a remote-work laptop → VPN + endpoint security. For SDLC questions, place the activity in its phase.",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">Network Scopes &amp; CIA Triad</text>\n  <circle cx=\"36\" cy=\"56\" r=\"12\" fill=\"rgba(122,171,207,.20)\" stroke=\"#7aabcf\" stroke-width=\"0.8\"/>\n  <text x=\"36\" y=\"60\" text-anchor=\"middle\" font-size=\"8\" fill=\"#7aabcf\" font-weight=\"700\">PAN</text>\n  <text x=\"36\" y=\"78\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#9ecef0\">~10 m</text>\n  <circle cx=\"82\" cy=\"56\" r=\"18\" fill=\"rgba(201,160,96,.20)\" stroke=\"#c9a060\" stroke-width=\"0.8\"/>\n  <text x=\"82\" y=\"60\" text-anchor=\"middle\" font-size=\"8\" fill=\"#c9a060\" font-weight=\"700\">LAN</text>\n  <text x=\"82\" y=\"82\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#d4b87a\">building</text>\n  <circle cx=\"138\" cy=\"56\" r=\"26\" fill=\"rgba(122,176,96,.18)\" stroke=\"#7ab060\" stroke-width=\"0.8\"/>\n  <text x=\"138\" y=\"60\" text-anchor=\"middle\" font-size=\"8\" fill=\"#7ab060\" font-weight=\"700\">WAN</text>\n  <text x=\"138\" y=\"90\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#a0c888\">cities/internet</text>\n  <rect x=\"178\" y=\"30\" width=\"76\" height=\"54\" rx=\"6\" fill=\"rgba(192,112,112,.15)\" stroke=\"#c07070\" stroke-width=\"0.8\"/>\n  <text x=\"216\" y=\"42\" text-anchor=\"middle\" font-size=\"8\" fill=\"#c07070\" font-weight=\"700\">CIA Triad</text>\n  <text x=\"216\" y=\"54\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">Confidentiality</text>\n  <text x=\"216\" y=\"64\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">Integrity</text>\n  <text x=\"216\" y=\"74\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">Availability</text>\n  <line x1=\"10\" y1=\"96\" x2=\"254\" y2=\"96\" stroke=\"#5e5e5e\" stroke-width=\"0.4\"/>\n  <text x=\"130\" y=\"107\" text-anchor=\"middle\" font-size=\"7\" fill=\"#888\">Threat: virus · worm · trojan · ransomware · phishing · DoS</text>\n </svg>",
    "caption": "Network scope expands left to right. CIA triad is the security goal of every IS.",
    "steps": [
      "Match scope to scenario: PAN (Bluetooth headset), LAN (office wifi), WAN (between cities), VPN (secure tunnel through public internet).",
      "For SDLC questions, locate the phase: requirements gathering = analysis; UML diagrams = design; user training = implementation.",
      "Distinguish threats: virus needs a host file; worm self-propagates; trojan disguises itself; ransomware encrypts and demands payment.",
      "Remember CIA: confidentiality (encryption, access control), integrity (hashing, checksums), availability (redundancy, backups).",
      "Database paradigms: relational (rows/columns, SQL), hierarchical (tree), network (graph), NoSQL (key-value, document)."
    ],
    "example": "Remote worker uses VPN (secure tunnel) into corporate LAN to access an SQL relational database. Files are encrypted in transit (confidentiality), have hash signatures (integrity), and a daily backup runs (availability). Every CIA element is engineered."
  },
  {
    "cat": "Financial Accounting",
    "tags": ["business", "accounting", "clep"],
    "title": "Financial Accounting — Equation, Statements & Cycle",
    "theory": "",
    "reality": "Every business transaction lands in one of three financial statements. The accounting equation balances by definition — if your books don't balance, something is missing. CLEP Financial Accounting tests the equation, double-entry rules, and how the balance sheet, income statement, and cash flow statement fit together.",
    "formula": "Accounting equation:\n  ASSETS  =  LIABILITIES  +  OWNER'S EQUITY\n\nDouble-entry rule: every transaction affects at least 2 accounts; total debits = total credits.\n\nNormal balances:\n  Assets, Expenses, Dividends → debit (DEAD)\n  Liabilities, Equity, Revenue → credit (CLEAR)\n\nThree main statements:\n  • INCOME STATEMENT  – Revenue − Expenses = Net Income (period)\n  • BALANCE SHEET     – Assets, Liabilities, Equity (point in time)\n  • CASH FLOW         – Operating + Investing + Financing\n\nAccounting cycle:\n  Transaction → Journal → Ledger → Trial Balance → Statements → Closing entries\n\nKey ratios:\n  Current ratio = Current Assets / Current Liabilities\n  Debt ratio    = Total Liabilities / Total Assets\n  Gross margin  = (Revenue − COGS) / Revenue",
    "method": "When a transaction is described, run the equation: which account goes up or down, and on which side? Use DEAD/CLEAR for normal balances. To check if a question is about which statement, ask: is it for a period (income, cash flow) or a snapshot (balance sheet)?",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">Accounting Equation &amp; Statements</text>\n  <rect x=\"10\" y=\"22\" width=\"60\" height=\"30\" rx=\"6\" fill=\"rgba(122,171,207,.18)\" stroke=\"#7aabcf\" stroke-width=\"0.9\"/>\n  <text x=\"40\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7aabcf\" font-weight=\"700\">ASSETS</text>\n  <text x=\"40\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">cash, AR, inv.</text>\n  <text x=\"77\" y=\"42\" text-anchor=\"middle\" font-size=\"14\" fill=\"#dce6f2\" font-weight=\"700\">=</text>\n  <rect x=\"86\" y=\"22\" width=\"76\" height=\"30\" rx=\"6\" fill=\"rgba(192,112,112,.15)\" stroke=\"#c07070\" stroke-width=\"0.9\"/>\n  <text x=\"124\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#c07070\" font-weight=\"700\">LIABILITIES</text>\n  <text x=\"124\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#e09090\">AP, loans, bonds</text>\n  <text x=\"167\" y=\"42\" text-anchor=\"middle\" font-size=\"14\" fill=\"#dce6f2\" font-weight=\"700\">+</text>\n  <rect x=\"176\" y=\"22\" width=\"78\" height=\"30\" rx=\"6\" fill=\"rgba(122,176,96,.15)\" stroke=\"#7ab060\" stroke-width=\"0.9\"/>\n  <text x=\"215\" y=\"36\" text-anchor=\"middle\" font-size=\"9\" fill=\"#7ab060\" font-weight=\"700\">EQUITY</text>\n  <text x=\"215\" y=\"47\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">stock + ret. earn.</text>\n  <line x1=\"10\" y1=\"60\" x2=\"254\" y2=\"60\" stroke=\"#5e5e5e\" stroke-width=\"0.4\"/>\n  <rect x=\"10\" y=\"66\" width=\"76\" height=\"40\" rx=\"6\" fill=\"rgba(122,171,207,.10)\" stroke=\"#7aabcf\" stroke-width=\"0.6\"/>\n  <text x=\"48\" y=\"79\" text-anchor=\"middle\" font-size=\"8.2\" fill=\"#7aabcf\" font-weight=\"700\">INCOME STMT</text>\n  <text x=\"48\" y=\"91\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">Rev − Exp = NI</text>\n  <text x=\"48\" y=\"101\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#9ecef0\">(over period)</text>\n  <rect x=\"92\" y=\"66\" width=\"76\" height=\"40\" rx=\"6\" fill=\"rgba(201,160,96,.10)\" stroke=\"#c9a060\" stroke-width=\"0.6\"/>\n  <text x=\"130\" y=\"79\" text-anchor=\"middle\" font-size=\"8.2\" fill=\"#c9a060\" font-weight=\"700\">BALANCE SHEET</text>\n  <text x=\"130\" y=\"91\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">A = L + E</text>\n  <text x=\"130\" y=\"101\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#d4b87a\">(snapshot)</text>\n  <rect x=\"174\" y=\"66\" width=\"80\" height=\"40\" rx=\"6\" fill=\"rgba(122,176,96,.10)\" stroke=\"#7ab060\" stroke-width=\"0.6\"/>\n  <text x=\"214\" y=\"79\" text-anchor=\"middle\" font-size=\"8.2\" fill=\"#7ab060\" font-weight=\"700\">CASH FLOW</text>\n  <text x=\"214\" y=\"91\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">Op + Inv + Fin</text>\n  <text x=\"214\" y=\"101\" text-anchor=\"middle\" font-size=\"6.5\" fill=\"#a0c888\">(over period)</text>\n </svg>",
    "caption": "Equation always balances. Three statements give three views of the same business.",
    "steps": [
      "For every transaction: identify the accounts changed and apply the equation. Did one asset go up while another went down? Did liabilities + equity stay balanced?",
      "Use DEAD/CLEAR for normal balances. Debit increases for Dividends, Expenses, Assets; credit increases for Liabilities, Equity, Revenue.",
      "Income Statement: revenues minus expenses for a period. Net income flows to retained earnings on the balance sheet.",
      "Balance Sheet: snapshot at a date. Always balances by definition.",
      "Cash Flow Statement: Operating (running the business), Investing (buying/selling long-term assets), Financing (debt + equity)."
    ],
    "example": "Company buys a $10,000 truck with cash. Assets: Truck +10,000, Cash −10,000. Net change in assets = 0. Liabilities and equity unchanged. Equation still balances. On cash-flow statement: investing activity, −$10,000."
  },
  {
    "cat": "Literature",
    "tags": ["english", "literature", "clep"],
    "title": "Literary Analysis — Genre, Tone, Imagery & Devices",
    "theory": "",
    "reality": "Reading a poem on a CLEP exam isn't about memorizing dates and authors — it's about NOTICING. Notice tone, notice imagery, notice the speaker's attitude, notice rhythm. CLEP Analyzing and Interpreting Literature tests close reading: can you describe what's happening in the text and how the writer is doing it?",
    "formula": "Three genres tested:\n  • POETRY    – meter, rhyme, imagery, figurative language\n  • PROSE     – fiction & nonfiction, narration, character\n  • DRAMA     – dialogue, soliloquy, stage direction\n\nLiterary devices to recognize:\n  Metaphor (no \"like/as\")  ·  Simile (\"like\" or \"as\")\n  Personification           ·  Hyperbole · Understatement\n  Symbol · Allegory         ·  Allusion (reference)\n  Irony (verbal/situational/dramatic)\n  Imagery (5 senses)        ·  Foreshadowing\n\nMeter (poetry):\n  Iamb (˘/) · Trochee (/˘) · Anapest (˘˘/) · Dactyl (/˘˘)\n  Pentameter = 5 feet/line   ·   Tetrameter = 4 feet/line\n\nTone vocabulary:\n  reverent · sardonic · melancholic · wistful · ambivalent\n  ironic · earnest · detached · contemplative · indignant",
    "method": "Three-pass close reading: First pass — what literally happens? Second pass — what's the SPEAKER's attitude (tone)? Third pass — which devices does the writer use, and what effect do they create? Most CLEP literature questions test the second and third passes.",
    "svg": "<svg viewBox=\"0 0 260 110\" xmlns=\"http://www.w3.org/2000/svg\">\n  <text x=\"130\" y=\"12\" text-anchor=\"middle\" font-size=\"9\" fill=\"#dce6f2\" font-weight=\"700\">Three-Pass Close Reading</text>\n  <rect x=\"10\" y=\"20\" width=\"76\" height=\"40\" rx=\"6\" fill=\"rgba(122,171,207,.15)\" stroke=\"#7aabcf\" stroke-width=\"0.8\"/>\n  <text x=\"48\" y=\"33\" text-anchor=\"middle\" font-size=\"8.5\" fill=\"#7aabcf\" font-weight=\"700\">PASS 1: WHAT</text>\n  <text x=\"48\" y=\"45\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">Plot, speaker,</text>\n  <text x=\"48\" y=\"54\" text-anchor=\"middle\" font-size=\"7\" fill=\"#9ecef0\">setting</text>\n  <rect x=\"92\" y=\"20\" width=\"76\" height=\"40\" rx=\"6\" fill=\"rgba(201,160,96,.15)\" stroke=\"#c9a060\" stroke-width=\"0.8\"/>\n  <text x=\"130\" y=\"33\" text-anchor=\"middle\" font-size=\"8.5\" fill=\"#c9a060\" font-weight=\"700\">PASS 2: TONE</text>\n  <text x=\"130\" y=\"45\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">Speaker's</text>\n  <text x=\"130\" y=\"54\" text-anchor=\"middle\" font-size=\"7\" fill=\"#d4b87a\">attitude</text>\n  <rect x=\"174\" y=\"20\" width=\"80\" height=\"40\" rx=\"6\" fill=\"rgba(122,176,96,.15)\" stroke=\"#7ab060\" stroke-width=\"0.8\"/>\n  <text x=\"214\" y=\"33\" text-anchor=\"middle\" font-size=\"8.5\" fill=\"#7ab060\" font-weight=\"700\">PASS 3: HOW</text>\n  <text x=\"214\" y=\"45\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">Devices &amp;</text>\n  <text x=\"214\" y=\"54\" text-anchor=\"middle\" font-size=\"7\" fill=\"#a0c888\">effect</text>\n  <line x1=\"10\" y1=\"66\" x2=\"254\" y2=\"66\" stroke=\"#5e5e5e\" stroke-width=\"0.4\"/>\n  <text x=\"14\" y=\"78\" font-size=\"7.5\" fill=\"#9ecef0\" font-weight=\"700\">FIGURATIVE: metaphor (no \"like\") · simile (\"like/as\") · personif.</text>\n  <text x=\"14\" y=\"90\" font-size=\"7.5\" fill=\"#d4b87a\" font-weight=\"700\">SOUND: alliteration · assonance · rhyme · meter (iamb /˘)</text>\n  <text x=\"14\" y=\"102\" font-size=\"7.5\" fill=\"#a0c888\" font-weight=\"700\">IRONY: verbal · situational · dramatic — what's said vs meant</text>\n </svg>",
    "caption": "Read three times: what, then tone, then how. Most CLEP questions live in passes 2 and 3.",
    "steps": [
      "First pass: paraphrase the literal content in plain English. Who is speaking? To whom? About what?",
      "Second pass: identify the tone. Is the speaker reverent, ironic, wistful, indignant? Look at word choice, especially adjectives and verbs.",
      "Third pass: find devices. Underline metaphors, similes, repetition, alliteration. Then ask: what effect does each create?",
      "For poetry: count syllables and accents to find the meter. Iambic pentameter = 10 syllables, every other one stressed (Shakespeare's default).",
      "For prose: identify point of view (first-person, third-limited, third-omniscient) and notice how it shapes what we know."
    ],
    "example": "\"The mountain wept silver tears.\" Pass 1: a mountain has streams of water on it. Pass 2: tone is contemplative, mournful. Pass 3: personification (mountains can't weep) + metaphor (streams are tears, tears are silver). Effect: the landscape is given grief, making nature feel emotionally alive."
  }
];
